...
******************************************************************************
    ...
    Description     : Check a Pt is inside polygon or not
    Notes           : 
*/
...
// Returns true if the Pt p lies inside the polygon[] with n vertices
bool isInside(Pt polygon[], int n, Pt p)
{
    // There must be at least 3 vertices in polygon[]
    if (n < 3) return false;
 
    // Create a Pt for line segment from p to infinite
    Pt extreme = {INF, p.y};
    ...
    do
    {
        ...
        {
            // If the Pt 'p' is colinear with line segment 'i-next',
